...
class CeleryExecutor(TaskExecutor):
    ...
    async def execute(
        ...
        logger.error("celery.not_implemented", message="CeleryExecutor not yet implemented")
    ...
    async def schedule(
        ...
        logger.error("celery.not_implemented", message="CeleryExecutor scheduling not yet implemented")
        raise NotImplementedError("CeleryExecutor will be implemented in Phase 3")