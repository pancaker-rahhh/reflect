...
class FastAPIExecutor(TaskExecutor):
    ...
    async def execute(
        ...
        self.background_tasks.add_task(self._execute_with_logging, task_name, task_func, payload)
    ...
    async def _execute_with_logging(self, task_name: str, task_func: Callable, payload: Dict[str, Any]):
        try:
