...
class Invitation(BaseModel):
    ...
    inviter = relationship(
        'User', foreign_keys=[invited_by], back_populates='sent_invitations'
    )
    accepter = relationship(
        'User', foreign_keys=[accepted_by], back_populates='accepted_invitations'
    )
...
class InvitationTask(Base, TimeStampMixin):
    ...
    )  # UUID as string for easier tracking
    user_id = Column(
