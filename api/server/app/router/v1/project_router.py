...
from app.schemas.project import ProjectCreate, ProjectUpdate, ProjectRead, PaginatedProjectRead, ProjectSettings, ProjectSettingsUpdate
...
async def get_project(
    ...
    project = await service.get_project_and_check_access(db, user=current_user, project_id=project_id)
    return project
...
async def update_project(
    ...
    project = await service.update_project(db, user=current_user, project_id=project_id, project_in=project_in)
    return project
...
async def get_project_settings(
    ...
    settings = await service.get_project_settings(db, user=current_user, project_id=project_id)
    return settings
