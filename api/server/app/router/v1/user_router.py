...
@user_router.get(
    '/me', response_model=UserProfileResponse, status_code=status.HTTP_200_OK
)
...
@user_router.delete(
    '/me', response_model=UserDeleteResponse, status_code=status.HTTP_200_OK
)
...
@user_router.post(
    '/sync', response_model=UserProfileResponse, status_code=status.HTTP_200_OK
)
