...
class WorkspaceRepository(BaseRepository[Workspace]):
    ...
    async def get_by_user_id(self, db: AsyncSession, user_id: UUID) -> Optional[Workspace]:
    ...
    async def get_with_projects(self, db: AsyncSession, workspace_id: UUID) -> Optional[Workspace]:
        stmt = (
            select(Workspace)
