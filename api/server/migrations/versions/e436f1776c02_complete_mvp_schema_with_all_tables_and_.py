...
def upgrade() -> None:
    ...
    sa.Column('app_metadata', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index(op.f('ix_organization_members_deleted_at'), 'organization_members', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_user_onboarding_created_at'), 'user_onboarding', ['created_at'], unique=False)
    op.create_index(op.f('ix_user_onboarding_deleted_at'), 'user_onboarding', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_user_onboarding_id'), 'user_onboarding', ['id'], unique=False)
    op.create_index(op.f('ix_user_onboarding_updated_at'), 'user_onboarding', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_feedback_forms_created_at'), 'feedback_forms', ['created_at'], unique=False)
    op.create_index(op.f('ix_feedback_forms_deleted_at'), 'feedback_forms', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_feedback_forms_id'), 'feedback_forms', ['id'], unique=False)
    op.create_index(op.f('ix_feedback_forms_updated_at'), 'feedback_forms', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_project_members_updated_at'), 'project_members', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_roadmaps_deleted_at'), 'roadmaps', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_roadmaps_id'), 'roadmaps', ['id'], unique=False)
    op.create_index(op.f('ix_roadmaps_project_id'), 'roadmaps', ['project_id'], unique=True)
    op.create_index(op.f('ix_roadmaps_public_slug'), 'roadmaps', ['public_slug'], unique=True)
    op.create_index(op.f('ix_roadmaps_updated_at'), 'roadmaps', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_webhooks_updated_at'), 'webhooks', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_form_fields_created_at'), 'form_fields', ['created_at'], unique=False)
    op.create_index(op.f('ix_form_fields_deleted_at'), 'form_fields', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_form_fields_updated_at'), 'form_fields', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_integration_mappings_created_at'), 'integration_mappings', ['created_at'], unique=False)
    op.create_index(op.f('ix_integration_mappings_deleted_at'), 'integration_mappings', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_integration_mappings_updated_at'), 'integration_mappings', ['updated_at'], unique=False)
    op.create_table('roadmap_columns',
    ...
    op.create_index(op.f('ix_roadmap_columns_created_at'), 'roadmap_columns', ['created_at'], unique=False)
    op.create_index(op.f('ix_roadmap_columns_deleted_at'), 'roadmap_columns', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_roadmap_columns_id'), 'roadmap_columns', ['id'], unique=False)
    op.create_index(op.f('ix_roadmap_columns_roadmap_id'), 'roadmap_columns', ['roadmap_id'], unique=False)
    op.create_index(op.f('ix_roadmap_columns_updated_at'), 'roadmap_columns', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_feedback_comments_deleted_at'), 'feedback_comments', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_feedback_comments_updated_at'), 'feedback_comments', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_feedback_votes_deleted_at'), 'feedback_votes', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_feedback_votes_updated_at'), 'feedback_votes', ['updated_at'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['column_id'], ['roadmap_columns.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['feedback_id'], ['feedback.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_roadmap_features_column_id'), 'roadmap_features', ['column_id'], unique=False)
    op.create_index(op.f('ix_roadmap_features_created_at'), 'roadmap_features', ['created_at'], unique=False)
    op.create_index(op.f('ix_roadmap_features_deleted_at'), 'roadmap_features', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_roadmap_features_feedback_id'), 'roadmap_features', ['feedback_id'], unique=False)
    op.create_index(op.f('ix_roadmap_features_id'), 'roadmap_features', ['id'], unique=False)
    op.create_index(op.f('ix_roadmap_features_updated_at'), 'roadmap_features', ['updated_at'], unique=False)
    ...
    op.create_table('roadmap_item_assignments',
    ...
    sa.ForeignKeyConstraint(['roadmap_feature_id'], ['roadmap_features.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('roadmap_feature_id', 'user_id', name='uq_roadmap_assignment')
    )
    op.create_index(op.f('ix_roadmap_item_assignments_created_at'), 'roadmap_item_assignments', ['created_at'], unique=False)
    op.create_index(op.f('ix_roadmap_item_assignments_deleted_at'), 'roadmap_item_assignments', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_roadmap_item_assignments_id'), 'roadmap_item_assignments', ['id'], unique=False)
    op.create_index(op.f('ix_roadmap_item_assignments_roadmap_feature_id'), 'roadmap_item_assignments', ['roadmap_feature_id'], unique=False)
    op.create_index(op.f('ix_roadmap_item_assignments_updated_at'), 'roadmap_item_assignments', ['updated_at'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_roadmap_item_assignments_updated_at'), table_name='roadmap_item_assignments')
    op.drop_index(op.f('ix_roadmap_item_assignments_roadmap_feature_id'), table_name='roadmap_item_assignments')
    op.drop_index(op.f('ix_roadmap_item_assignments_id'), table_name='roadmap_item_assignments')
    op.drop_index(op.f('ix_roadmap_item_assignments_deleted_at'), table_name='roadmap_item_assignments')
    op.drop_index(op.f('ix_roadmap_item_assignments_created_at'), table_name='roadmap_item_assignments')
    ...
    op.drop_index(op.f('ix_roadmap_features_feedback_id'), table_name='roadmap_features')
    ...
    op.drop_index(op.f('ix_feedback_comments_updated_at'), table_name='feedback_comments')
    ...
    op.drop_index(op.f('ix_feedback_comments_deleted_at'), table_name='feedback_comments')
    ...
    op.drop_index(op.f('ix_integration_mappings_updated_at'), table_name='integration_mappings')
    ...
    op.drop_index(op.f('ix_integration_mappings_deleted_at'), table_name='integration_mappings')
    op.drop_index(op.f('ix_integration_mappings_created_at'), table_name='integration_mappings')
    ...
    op.drop_index(op.f('ix_organization_members_deleted_at'), table_name='organization_members')
