...
def upgrade() -> None:
    ...
    op.create_table('invitation_tasks',
    ...
    op.create_index(op.f('ix_invitation_tasks_created_at'), 'invitation_tasks', ['created_at'], unique=False)
    op.create_index(op.f('ix_invitation_tasks_updated_at'), 'invitation_tasks', ['updated_at'], unique=False)
    ...
    op.create_table('invitations',
        ...
        sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'EXPIRED', 'CANCELLED', name='invitationstatus'), nullable=False, server_default='PENDING'),
    ...
    op.create_index(op.f('ix_invitations_updated_at'), 'invitations', ['updated_at'], unique=False)
    
    # Create pending_members table
    op.create_table('pending_members',
        sa.Column('email', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_pending_members_created_at'), 'pending_members', ['created_at'], unique=False)
    op.create_index(op.f('ix_pending_members_deleted_at'), 'pending_members', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_pending_members_email'), 'pending_members', ['email'], unique=False)
    op.create_index(op.f('ix_pending_members_id'), 'pending_members', ['id'], unique=False)
    op.create_index(op.f('ix_pending_members_updated_at'), 'pending_members', ['updated_at'], unique=False)
...
def downgrade() -> None:
    ...
    # Revert table changes (simplified - you may need to adjust based on original schema)
    op.drop_constraint('fk_webhooks_created_by', 'webhooks', type_='foreignkey')
    ...
    op.drop_constraint('fk_integrations_created_by', 'integrations', type_='foreignkey')
    ...
    op.execute('DROP TYPE IF EXISTS integrationstatus CASCADE')
    op.execute('DROP TYPE IF EXISTS integrationtype CASCADE')
