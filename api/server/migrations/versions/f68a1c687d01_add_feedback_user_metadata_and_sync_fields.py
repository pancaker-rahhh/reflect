"""add_user_metadata_and_sync_fields

Revision ID: f68a1c687d01
Revises: 12aa594305ee
Create Date: 2025-08-09 15:59:31.760084
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('user_metadata', postgresql.JSON(astext_type=sa.Text()), nullable=False))
    op.add_column('users', sa.Column('app_metadata', postgresql.JSON(astext_type=sa.Text()), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'app_metadata')
