...
const comparisonData = [
  { feature: 'In-App Widget', reflect: true, noora: false },
  { feature: 'Screenshot Bug Reports', reflect: true, noora: false },
  { feature: 'Free Plan', reflect: true, noora: false },
  { feature: 'Feature Voting', reflect: true, noora: true },
  { feature: 'Public Roadmap', reflect: true, noora: true },
  { feature: 'Lightweight', reflect: true, noora: false },
  { feature: '5-Minute Setup', reflect: true, noora: false },
]

export default function ReflectVsNooraPage() {
  usePageAnalytics()
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-foreground mb-6">
                Reflect vs Noora: Best Alternative to Noora in 2025
              </h1>
              <p className="text-lg sm:text-xl leading-8 text-muted-foreground">
                Compare Reflect's comprehensive feedback platform with Noora's feature request tool.
            ...
            <div className="mx-auto max-w-5xl space-y-12">
              ...
              >
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>
                    Noora is a feedback and feature request management tool that helps teams collect
                    and organize user feedback. It offers a simple interface for creating feedback
                    boards where users can submit and vote on feature requests.
                  </p>
                  <p>
                    Noora focuses on simplicity and ease of use, making it accessible for teams that
                    want a straightforward feedback collection solution. The platform offers basic
                    feature request management and voting capabilities.
                  </p>
                  <p>
                    However, Noora lacks native in-app feedback collection and doesn't offer bug
                    reporting or comprehensive feedback management features. Teams using Noora often
                    need additional tools for complete feedback management.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>
                    ...
                    application, reducing friction and increasing response rates. Noora relies on
                    external boards.
                  </p>
                  <p>
                    <strong className="text-foreground">Bug Reporting:</strong> Built-in screenshot
                    capture and bug reporting make Reflect a complete solution. Noora doesn't offer
                    bug reporting capabilities.
                  </p>
                  <p>
                    <strong className="text-foreground">Free Plan:</strong> Reflect offers a
                    generous free plan to get started. Noora's pricing can be a barrier for smaller
                    teams.
                  </p>
                  <p>
                    ...
                    platform. Noora focuses primarily on feature requests.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-card rounded-xl p-6 border border-border">
                    <h3 className="text-xl font-bold text-foreground mb-4">Choose Noora If:</h3>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <Check className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                        <span>You only need basic feature request boards</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <Check className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
              ...
              >
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>Migrating from Noora to Reflect:</p>
                  <ol className="list-decimal list-inside space-y-3 ml-4">
                    <li>Export your Noora feedback and feature requests</li>
