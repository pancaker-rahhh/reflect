...
const steps = [
  {
    step: 1,
    title: 'Connect Jira',
    description: 'Authorize Reflect to access your Jira instance.',
  },
  {
    step: 2,
    title: 'Map to Issues',
    description: 'Configure how feedback converts to Jira issues.',
  },
  {
    step: 3,
  ...
  },
  {
    ...
    description: 'All new feedback automatically creates Jira issues.',
  },
]

export default function ReflectJiraPage() {
  usePageAnalytics()
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-foreground mb-6">
                Reflect + Jira: Send Feedback & Bug Reports to Jira
              </h1>
              <p className="text-lg sm:text-xl leading-8 text-muted-foreground">
                Automatically convert user feedback and bug reports into Jira issues. Keep your
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl space-y-12">
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
                  Why Integrate Reflect with Jira?
                </h2>
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>
                    <strong className="text-foreground">Automatic Issue Creation:</strong> Every bug
                    report automatically becomes a Jira issue with screenshots and context.
                  </p>
                  <p>
                    <strong className="text-foreground">Seamless Workflow:</strong> Keep your
                    development team in Jira while feedback flows in from Reflect.
                  </p>
                  <p>
                    <strong className="text-foreground">Rich Context:</strong> Jira issues include
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
                  Ready to Connect Reflect with Jira?
                </h2>
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Start automatically creating Jira issues from user feedback.
                </p>
