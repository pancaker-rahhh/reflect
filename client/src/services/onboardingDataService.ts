...
class OnboardingDataService {
  ...
  getAllData(): OnboardingFormData {
    return {
      profile: this.getStepData('profile') as OnboardingFormData['profile'],
      organization: this.getStepData('organization') as OnboardingFormData['organization'],
      project: this.getStepData('project') as OnboardingFormData['project'],
      team: this.getStepData('team') as OnboardingFormData['team'],
    }
  }
  ...
  getProfileData(): OnboardingFormData['profile'] {
    return this.getStepData('profile') as OnboardingFormData['profile']
  }

  getOrganizationData(): OnboardingFormData['organization'] {
    return this.getStepData('organization') as OnboardingFormData['organization']
  }

  getProjectData(): OnboardingFormData['project'] {
    return this.getStepData('project') as OnboardingFormData['project']
  }

  getTeamData(): OnboardingFormData['team'] {
    return this.getStepData('team') as OnboardingFormData['team']
  }
}
