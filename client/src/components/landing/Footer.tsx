                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li><a href="#features" onClick={(e) => handleNavClick(e, 'features')} className="text-gray-600 hover:text-purple-600 transition-colors">Features</a></li>
                            <li><a href="#solution" onClick={(e) => handleNavClick(e, 'solution')} className="text-gray-600 hover:text-purple-600 transition-colors">Solution</a></li>
                            <li><a href="#faq" onClick={(e) => handleNavClick(e, 'faq')} className="text-gray-600 hover:text-purple-600 transition-colors">FAQ</a></li>
                            <li><a href="#pricing" onClick={(e) => handleNavClick(e, 'pricing')} className="text-gray-600 hover:text-purple-600 transition-colors">Pricing</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            ...
                            <li><button onClick={() => navigate('/docs')} className="text-gray-600 hover:text-purple-600 transition-colors">Docs</button></li>
