  ...
  return (
    <footer className="bg-background border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-6 sm:gap-8 text-sm">
          ...
          <div className="col-span-2 sm:col-span-3 md:col-span-1">
            ...
            <div className="mt-6 flex items-center space-x-5">
              ...
              <a
                href="https://github.com/reflectfeedback"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="mt-8 sm:mt-12 border-t border-border pt-6 flex justify-center items-center">
