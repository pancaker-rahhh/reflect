...
export const BrandingSection = () => {
  return (
  <section id="cta" className="relative bg-background overflow-hidden py-8 sm:py-10 lg:py-12">
                    ...
                    return Array.from({ length: 3 }).map((_, row) => {
                      ...
                      return (
                        <div key={row} className="relative w-full overflow-visible">
                          {/* main repeated row */}
                          <div className="flex items-center justify-center gap-4 sm:gap-6 lg:gap-8 whitespace-nowrap">
                            {Array.from({ length: 6 }).map((__, col) => (
                              <span
                                key={col}
                                className="inline-block outlined-primary font-extrabold tracking-tight font-bungee-outline text-[clamp(28px,5vw,90px)] leading-none"
                                style={{
                                  WebkitTextStroke: `${Math.max(2, 4 - row * 0.2)}px hsl(var(--primary))`,
                                  color: 'transparent',
                                  backgroundClip: 'text',
                          ...
                          <div
                            className="absolute inset-0 flex items-center justify-center gap-4 sm:gap-6 lg:gap-8 whitespace-nowrap pointer-events-none"
                          ...
                          >
                            {Array.from({ length: 6 }).map((__, col) => (
                              <span
                                ...
                                className="inline-block outlined-primary font-extrabold tracking-tight font-bungee-outline text-[clamp(28px,5vw,90px)] leading-none"
                                style={{
                                  WebkitTextStroke: `${Math.max(1, 2 - row * 0.15)}px hsl(var(--primary))`,
                                  color: 'transparent',
                                  backgroundClip: 'text',
                                  WebkitBackgroundClip: 'text',
                                  WebkitTextFillColor: 'transparent',
