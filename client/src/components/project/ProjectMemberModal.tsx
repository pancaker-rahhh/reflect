      ...
      <div className="relative bg-background border border-border rounded-xl shadow-2xl max-w-md w-full mx-4 animate-fade-in">
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-foreground">Add Project Member</h2>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-blue-800 text-sm">
                  <strong>Note:</strong> This user will be invited to both the organization and this
                  project. They'll receive an email invitation to join.
                </p>
              </div>
            </div>
          )}
